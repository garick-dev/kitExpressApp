...
class ReviewsBlockAddCompleted extends StatelessWidget {
  const ReviewsBlockAddCompleted({Key? key}) : super(key: key);
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    child: Row(
                        ...
                        children: [
                          const Expanded(child: Text("Спасибо: ваш отзыв принят и будет опубликован после проверки модератером!", maxLines: 10,
