    ...
    return Container(
      ...
      child: Column(
        ...
        children:  [
          ...
          const Text("Ближайшая доставка послезавтра, 9 октября, бесплатно",
              style: TextStyle(fontFamily: openSans400, fontSize: 18, letterSpacing: customLetterSpacing, color: blackColor)),
          const Padding(padding: EdgeInsets.only(top: 20.0),),
