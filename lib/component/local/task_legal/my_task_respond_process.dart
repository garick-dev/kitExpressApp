...
class MyTaskRespondProcess extends StatefulWidget {
  const MyTaskRespondProcess({Key? key}) : super(key: key);

  @override
  State<MyTaskRespondProcess> createState() => _MyTaskRespondProcessState();
}

class _MyTaskRespondProcessState extends State<MyTaskRespondProcess> {
        ...
        children: [
          ...
          SizedBox(
              ...
              child: ElevatedButton(
                  ...
                  onPressed: (){},
                  child: const Text("Задание выполнено",
          ...
          SizedBox(
              ...
              child: ElevatedButton(
                  ...
                  onPressed: (){},
                  child: const Text("Отказаться от задания",
                    style: TextStyle(fontFamily: openSans700, fontSize: 20, letterSpacing: customLetterSpacing),))
          ),
