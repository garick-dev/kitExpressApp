...
class FullCartDeactive extends StatelessWidget {
  const FullCartDeactive({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const FullCartDeactiveState(),
    );
  }
}

class FullCartDeactiveState extends StatefulWidget {
  const FullCartDeactiveState({Key? key}) : super(key: key);
  @override
  State<StatefulWidget> createState() => _FullCartDeactiveState();

}

class _FullCartDeactiveState extends State<FullCartDeactiveState>  with SingleTickerProviderStateMixin{
