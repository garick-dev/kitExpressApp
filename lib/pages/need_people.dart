...
class NeedPeople extends StatefulWidget {
  const NeedPeople({Key? key}) : super(key: key);

  @override
  State<NeedPeople> createState() => _NeedPeopleState();
}

class _NeedPeopleState extends State<NeedPeople> {
              ...
              children: [
                Row(
                  ...
                  children: [
                    const SizedBox(
                        width: 200,
                        child: Text("Нужны люди", softWrap: true,
                          style: TextStyle(
                            fontSize: 24,
