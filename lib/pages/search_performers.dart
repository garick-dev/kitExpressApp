...
import 'package:testproject/component/global/preview_performers_card.dart';

class SearchPerformers extends StatefulWidget {
  const SearchPerformers({Key? key}) : super(key: key);

  @override
  State<SearchPerformers> createState() => _SearchPerformersState();
}

class _SearchPerformersState extends State<SearchPerformers> {
            ...
            children: [
              Row(
                ...
                children: [
                  const SizedBox(
                      width: 200,
                      child: Text("Поиск исполнителей", softWrap: true,
                        style: TextStyle(
                          fontSize: 24,
                          ...
                          child: Row(children: [
                            ...
                            Container(
                              ...
                              ElevatedButton(
                                ...
                                onPressed: (){}, child: const Text("Дизайнеры",
                            ...
                            Container(
                              ...
                              ElevatedButton(
                                ...
                                onPressed: (){}, child: const Text("Строители",
                                style: TextStyle(fontFamily: montserrat500, fontSize: 12, letterSpacing: customLetterSpacing, color: blackColor),),),
                            ...
                            Container(
                              ...
                              ElevatedButton(
                                ...
                                onPressed: (){}, child: const Text("Архитекторы",
                                style: TextStyle(fontFamily: montserrat500, fontSize: 12, letterSpacing: customLetterSpacing, color: blackColor),),),
