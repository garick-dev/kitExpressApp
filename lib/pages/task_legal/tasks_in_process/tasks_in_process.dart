...
class TasksInProcess extends StatefulWidget {
  const TasksInProcess({Key? key}) : super(key: key);

  @override
  State<TasksInProcess> createState() => _TasksInProcessState();
}

class _TasksInProcessState extends State<TasksInProcess> {
              ...
              children: [
                Row(
                  ...
                  children: [
                    const SizedBox(
                        width: 200,
                        child: Text("Задания \"в процессе\"", softWrap: true,
                          style: TextStyle(
                            fontSize: 24,
