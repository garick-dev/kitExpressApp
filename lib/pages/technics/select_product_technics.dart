...
class SelectProductTechnics extends StatefulWidget {
  const SelectProductTechnics({Key? key}) : super(key: key);

  @override
  State<SelectProductTechnics> createState() => _SelectProductTechnicsState();
}

class _SelectProductTechnicsState extends State<SelectProductTechnics> {
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    const Expanded( child: Text("Строительная техника в аренду",
                          maxLines: 5,
                          softWrap: true,
                          style: TextStyle(
                            fontSize: 24,
