...
class FullCartDeactiveTransportation extends StatelessWidget {
  const FullCartDeactiveTransportation({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const FullCartDeactiveTransportationState(),
    );
  }
}

class FullCartDeactiveTransportationState extends StatefulWidget {
  const FullCartDeactiveTransportationState({Key? key}) : super(key: key);
  @override
  State<StatefulWidget> createState() => _FullCartDeactiveTransportationState();

}

class _FullCartDeactiveTransportationState extends State<FullCartDeactiveTransportationState>  with SingleTickerProviderStateMixin{
